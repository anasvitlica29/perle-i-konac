...
const TwoImageTextSection = ({
  ...
  return (
    <div
      className={`flex ${reverse ? "flex-col-reverse md:flex-row-reverse md:mb-28" : "flex-col md:flex-row"}  md:flex-row gap-8 md:gap-12 justify-center w-full overflow-x-clip`}
    >
      <div
